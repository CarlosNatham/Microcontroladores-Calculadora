...
void initLCD() {
    ...
    pLCD = (struct tDisplayPort *) &PORTD;
    pLCD ->E = 0;
    pLCD ->RS = 0;
    pLCD ->R_W = 0;
    TRISD = 0;
...
void main(void) {
    ...
    TRISBbits.RB7 = 1;
    INTCON2bits.RBPU = 0;
    char equacao[10], vetaux1[10], vetaux2[10];
    float num1, num2;
    char op;
    float resp = 0.0;
    int i = 0;
